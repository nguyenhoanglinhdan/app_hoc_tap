...
class HomePage(tk.Frame):
    topic_list = ["math", "science", "english", "history", "geography", "biology", "chemistry", "physics", "social", "art", "music", "physical education", "computer science", "foreign language", "other"]
    grade_list = ["grade 1", "grade 2", "grade 3", "grade 4", "grade 5", "grade 6", "grade 7", "grade 8", "grade 9"]
    ...
    def create_header(self):
        ttk.Label(self, text="Vocabulary Management", font=("Arial", 16, "bold")).grid(row=0, column=0, columnspan=3, pady=20)
        ttk.Label(self, text="Select Grade and Topic", font=("Arial", 12, "bold")).grid(row=1, column=0, columnspan=3, pady=10)
    ...
    def create_body(self):
        ...
        # Add button
        add_button = ttk.Button(self, text="Add Vocabulary", command=self.add_vocabulary)
        add_button.grid(row=4, column=0, columnspan=2, pady=20)

    def add_vocabulary(self):
        if self.grade_var.get() == "" or self.topic_var.get() == "":
            messagebox.showerror("Error", "Please select both grade and topic")
            return
...
class InsertForm(tk.Frame):
    ...
    def create_header(self):
        ...
        ttk.Label(self, text=f"Grade: {self.grade} | Topic: {self.topic}", font=("Arial", 10)).grid(row=1, column=0, columnspan=3, pady=5)
    ...
    def create_body(self):
        ...
        ttk.Label(self, text="Existing Vocabulary:", font=("Arial", 10, "bold")).grid(row=6, column=0, columnspan=3, pady=(20,5), sticky="w")
    ...
    def save_word(self):
        ...
        folder_path = f"{self.grade}/{self.topic}".lower().replace(" ", "_")
...
class MainApplication:
    ...
    def show_home_page(self):
        ...
        self.current_frame = HomePage(self.root, self.show_insert_form)
    
    def show_insert_form(self, grade, topic):
        if self.current_frame:
            self.current_frame.destroy()
        self.current_frame = InsertForm(self.root, grade, topic, self.show_home_page)


if __name__ == "__main__":
    root = tk.Tk()
    root.title("Vocabulary Management")
