...
class HomePage(tk.Frame):
    topic_list = ["math", "science", "english", "history", "geography", "biology", "chemistry", "physics", "social",
    ...
    def create_header(self):
        ttk.Label(self, text="Vocabulary Management", font=("Arial", 16, "bold")).grid(row=0, column=0, columnspan=3,
                                                                                       pady=20)
        ttk.Label(self, text="Select Grade and Topic", font=("Arial", 12, "bold")).grid(row=1, column=0, columnspan=3,
                                                                                        pady=10)
...
if __name__ == "__main__":
    print("Hello! Welcome to Vocabulary Management System.")
    root = tk.Tk()
