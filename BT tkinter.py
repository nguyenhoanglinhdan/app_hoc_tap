...
class Book(tk.Frame):
    ...
    def __init__(self, khung):
        tk.Frame.__init__(self, khung)

        self.pack(fill ="both", expand = True, padx = 5, pady = 5)
        self.columnconfigure(1, weight = 2)

        ttk.Label(self, text = 'Tên cuốn sách').grid(row = 0, column = 0, padx = 5, pady = 5, sticky = 'w')
        ...
        self.ten_sach.grid(row = 0, column = 1,padx = 5, pady = 5, sticky = 'ew')
